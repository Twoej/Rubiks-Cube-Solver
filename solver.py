...
def solve(current_cube):
	...
	#win.getMouse()
	solution_current = solve_iddfs(current_cube_masked, 11, g1_state)
	...
	#win.getMouse()
	solution_current = solve_iddfs(current_cube_masked, 11, g2_state)
	...
	#win.getMouse()
	solution_current = solve_iddfs(current_cube_masked, 12, g3_state)
	print(solution_current)
	if solution_current != None:
		current_cube = apply_moves(current_cube, solution_current)
		solution += solution_current
	...
	#renderedcube.draw_cube(current_cube, win)
	#win.getMouse()
	solution_current = solve_iddfs(current_cube, 14, g4_state)
	print(solution_current)
	if solution_current != None:
		current_cube = apply_moves(current_cube, solution_current)
		solution += solution_current
